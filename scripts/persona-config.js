...
export const PERSONAS = {
  SARAH: {
    ...
    primaryWarehouse: 'West Coast Distribution Center',
  ...
  MARCUS: {
    ...
    primaryWarehouse: 'East Coast Distribution Center',
  ...
  DAVID: {
    ...
    primaryWarehouse: 'Central Distribution Center',
  ...
  KEVIN: {
    ...
    region: 'Central Region',
    primaryWarehouse: 'Central Distribution Center',
    hasMultipleLocations: true, // Kevin's company has multiple locations
    description: 'Managing inventory for pro contractor supply yard',
