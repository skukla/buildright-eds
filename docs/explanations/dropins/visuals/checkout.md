...
The Checkout dropin uses a single container with multiple slots for each step:
...
| |                                                          | |
| | +------------------------------------------------------+ | |
| | | BillingAddress SLOT (if different from shipping)      | | |
| | | [Address form fields]                                 | | |
| | +------------------------------------------------------+ | |
| |                                                          | |
| | +------------------------------------------------------+ | |
...
| |                                                          | |
| | +---------------------------+---------------------------+ | |
| | | PlaceOrder SLOT           | OrderSummary SLOT         | | |
| | | [ Place Order ]           | Items, Subtotal, Total    | | |
| | +---------------------------+---------------------------+ | |
| |                                                          | |
| +----------------------------------------------------------+ |
+-------------------------------------------------------------+
...
|------|---------------|---------------------|-------|
| **ShippingAddress** | Address form | ❌ Using default | Level 1 |
| **ShippingMethods** | Radio options | ❌ Using default | Level 1 |
| **BillingAddress** | Address form | ❌ Using default | Level 1 |
| **PaymentMethods** | Card inputs | ❌ Using default | Level 1 |
| **OrderSummary** | Totals display | ❌ Using default | Level 1 |
| **PlaceOrder** | Submit button | ❌ Using default | Level 1 |

**Note**: Checkout uses **Level 1** customization (CSS styling only). Adobe's default checkout UI provides a complete, professional experience.
...
|                                                                             |
|  +-----------------------------------------------------------------------+  |
|  | header (EDS Block - simplified, minimal navigation)                   |  |
|  +-----------------------------------------------------------------------+  |
|                                                                             |
|  +=======================================================================+  |
|  || checkout-dropin (EDS Block)                                         ||  |
...
|  ||  | |                           |                               | |  ||  |
|  ||  | | +------------------------+| +---------------------------+ | |  ||  |
|  ||  | | | ShippingAddress SLOT   || | OrderSummary SLOT         | | |  ||  |
|  ||  | | +------------------------+| | Items, totals, final cost | | |  ||  |
|  ||  | |                           | +---------------------------+ | |  ||  |
|  ||  | | +------------------------+|                               | |  ||  |
|  ||  | | | ShippingMethods SLOT   ||                               | |  ||  |
|  ||  | | +------------------------+|                               | |  ||  |
