...
**Purpose**: Fast, 1-page guides for common implementation tasks

These guides provide just enough context to get started quickly, with links to comprehensive docs for deeper dives.
...
| Guide | Time | Purpose |
|-------|------|---------|
| **[implement-persona.md](./implement-persona.md)** | 2 min | How to implement a new persona (high-level) |
...
1. Read [architecture-overview.md](./architecture-overview.md) (5 min)
2. Read [what-exists.md](./what-exists.md) (3 min)
...
**30-second rule**: Each guide answers "What do I need to know RIGHT NOW?"
...
**Not comprehensive** - that's what the full docs are for!
