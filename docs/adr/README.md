...
| [ADR-022](./ADR-022-dropin-inspector-detection-requirements.md) | Dropin Inspector Detection Requirements | Accepted | 2026-01-14 |
...
**Last Updated**: January 14, 2026 (Added ADR-022: Dropin Inspector Detection Requirements)
